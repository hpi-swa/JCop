...
public class WhileStmt extends BranchTargetStmt implements Cloneable {
  ...
  public void typeCheck() {
    ...
    // Declared in CreateBCode.jrag at line 1326
            ...
            if(isFinal && num == boundariesCrossed)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean canCompleteNormally() {
    ...
    // Declared in CreateBCode.jrag at line 938
 @SuppressWarnings({"unchecked", "cast"})     public boolean definesLabel() {
    ...
    // Declared in CreateBCode.jrag at line 1322
 @SuppressWarnings({"unchecked", "cast"})     public int cond_label() {
    ...
    // Declared in CreateBCode.jrag at line 1323
 @SuppressWarnings({"unchecked", "cast"})     public int end_label() {
    ...
    // Declared in CreateBCode.jrag at line 1324
 @SuppressWarnings({"unchecked", "cast"})     public int stmt_label() {
 ...
 @SuppressWarnings({"unchecked", "cast"})     public int break_label() {
    ...
    // Declared in CreateBCode.jrag at line 1401
 @SuppressWarnings({"unchecked", "cast"})     public int continue_label() {
    ...
    // Declared in CreateBCode.jrag at line 946
    ...
    // Declared in CreateBCode.jrag at line 945
