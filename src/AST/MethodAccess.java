...
package AST;
import java.util.HashSet;import java.util.LinkedHashSet;import java.io.File;import java.util.*;import beaver.*;import java.util.ArrayList;import java.util.zip.*;import java.io.*;import java.util.Collection;
...
public class MethodAccess extends Access implements Cloneable {
  ...
  public void nameCheck() {
    ...
    if(decls().isEmpty() && (!isQualified() || !qualifier().isUnknown())) {
      ...
      s.append("no method named " + name() + enclosingBodyDecl());
      s.append("(");
      for(int i = 0; i < getNumArg(); i++) {
        if(i != 0)
          s.append(", ");
    ...
    // Declared in CreateBCode.jrag at line 528
  ...
  private static SimpleSet mostSpecific(SimpleSet maxSpecific, MethodDecl decl) {
    ...
    // Declared in graphGeneration.jrag at line 69
  ...
  // refine old type checking to be valid when using variable arity parameters
    ...
    // Declared in GenericsCodegen.jrag at line 110
    ...
    // Declared in GenericsCodegen.jrag at line 146
