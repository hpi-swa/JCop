...
public class DoStmt extends BranchTargetStmt implements Cloneable {
  ...
  public void typeCheck() {
    ...
    // Declared in CreateBCode.jrag at line 1343
            ...
            if(isFinal && num == boundariesCrossed)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean canCompleteNormally() {
    ...
    // Declared in CreateBCode.jrag at line 939
 @SuppressWarnings({"unchecked", "cast"})     public boolean definesLabel() {
    ...
    // Declared in CreateBCode.jrag at line 1339
 @SuppressWarnings({"unchecked", "cast"})     public int begin_label() {
    ...
    // Declared in CreateBCode.jrag at line 1340
 @SuppressWarnings({"unchecked", "cast"})     public int cond_label() {
    ...
    // Declared in CreateBCode.jrag at line 1341
 @SuppressWarnings({"unchecked", "cast"})     public int end_label() {
    ...
    // Declared in CreateBCode.jrag at line 1383
 @SuppressWarnings({"unchecked", "cast"})     public int break_label() {
    ...
    // Declared in CreateBCode.jrag at line 1402
 @SuppressWarnings({"unchecked", "cast"})     public int continue_label() {
    ...
    // Declared in CreateBCode.jrag at line 948
    ...
    // Declared in CreateBCode.jrag at line 947
