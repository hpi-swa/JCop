...
public class CompilationUnit extends ASTNode<ASTNode> implements Cloneable {
  ...
  public void transformation() {
    ...
    // Declared in caching.jrag at line 6
    ...
    // Declared in graphGeneration.jrag at line 21
  ...
  public jcop.output.graph.INode createGraphNode() {
    ...
    // Declared in xmlOutline.jrag at line 4
...
private SimpleSet refined_LookupType_Child_lookupType_String(String name)
{
    ...
    // Declared in Generics.jrag at line 25
private SimpleSet refined_Generics_Child_lookupType_String(String name)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public String packageName() {
    ...
    // Declared in ConstantPoolNames.jrag at line 68
   ...
   int childIndex = caller.getIndexOfChild(child);
{
    ...
    // Declared in ConstantPoolNames.jrag at line 66
   ...
   int childIndex = this.getIndexOfChild(caller);
{
		SimpleSet result = refined_Generics_Child_lookupType_String(name);
		if (result.isEmpty()) {
