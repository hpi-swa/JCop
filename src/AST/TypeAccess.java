...
public class TypeAccess extends Access implements Cloneable {
  ...
  public void typeCheck() {
    ...
    // Declared in auxiliary.jrag at line 50
    ...
    // Declared in graphGeneration.jrag at line 98
  ...
  public boolean mayHaveRewrite() { return false; }
    ...
    // Declared in GenericsCodegen.jrag at line 292


    public void transformation() {
    super.transformation();
    if(type().elementType().isNestedType() && hostType() != null)
      hostType().addUsedNestedType(type().elementType().erasure());
  }
