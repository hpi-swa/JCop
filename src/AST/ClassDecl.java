...
public class ClassDecl extends ReferenceType implements Cloneable {
 ...
 public void checkModifiers() {
  ...
  public ClassDecl p(Parameterization parTypeDecl) {
    ...
    // Declared in graphGeneration.jrag at line 17
  ...
  public jcop.output.graph.INode createGraphNode() {
    ...
    // Declared in xmlOutline.jrag at line 54
            ...
            if(isFinal && num == boundariesCrossed)
{
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean supertypeArrayDecl(ArrayDecl type) {
    ...
    // Declared in GenericsCodegen.jrag at line 225
 @SuppressWarnings({"unchecked", "cast"})     public SimpleSet bridgeCandidates(String signature) {
    ...
    // Declared in GenericsCodegen.jrag at line 336
 @SuppressWarnings({"unchecked", "cast"})     public boolean needsSignatureAttribute() {
    ...
    // Declared in GenericsCodegen.jrag at line 374
 @SuppressWarnings({"unchecked", "cast"})     public String classSignature() {
    ...
    // Declared in layer_decl.jrag at line 92
