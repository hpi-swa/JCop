...
public class ForStmt extends BranchTargetStmt implements Cloneable, VariableScope {
  ...
  public void typeCheck() {
    ...
    // Declared in CreateBCode.jrag at line 1357
...
if(localVariableDeclaration_String_values == null) localVariableDeclaration_String_values = new java.util.HashMap(4);
 ...
 @SuppressWarnings({"unchecked", "cast"})     public boolean canCompleteNormally() {
    ...
    // Declared in CodeGeneration.jrag at line 45
 @SuppressWarnings({"unchecked", "cast"})     public int variableScopeEndLabel(CodeGeneration gen) {
...
if(variableScopeEndLabel_CodeGeneration_values == null) variableScopeEndLabel_CodeGeneration_values = new java.util.HashMap(4);
    ...
    // Declared in CreateBCode.jrag at line 940
 @SuppressWarnings({"unchecked", "cast"})     public boolean definesLabel() {
    ...
    // Declared in CreateBCode.jrag at line 1352
 @SuppressWarnings({"unchecked", "cast"})     public int cond_label() {
    ...
    // Declared in CreateBCode.jrag at line 1353
 @SuppressWarnings({"unchecked", "cast"})     public int begin_label() {
 ...
 @SuppressWarnings({"unchecked", "cast"})     public int update_label() {
    ...
    // Declared in CreateBCode.jrag at line 1355
 @SuppressWarnings({"unchecked", "cast"})     public int end_label() {
    ...
    // Declared in CreateBCode.jrag at line 1381
 @SuppressWarnings({"unchecked", "cast"})     public int break_label() {
    ...
    // Declared in CreateBCode.jrag at line 1400
 @SuppressWarnings({"unchecked", "cast"})     public int continue_label() {
...
if(lookupVariable_String_values == null) lookupVariable_String_values = new java.util.HashMap(4);
    ...
    // Declared in CreateBCode.jrag at line 950
    ...
    // Declared in CreateBCode.jrag at line 949
    ...
    // Declared in LocalNum.jrag at line 102
